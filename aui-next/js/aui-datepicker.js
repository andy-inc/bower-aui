    ...
    AJS.DatePicker = function (field, options) {
        ...
        initPolyfill = function () {
            ...
            datePicker.hide = function () {
                popup.hide();
                if (parentPopup && parentPopup.data && parentPopup.data("_datePickerPopup")) {
                    parentPopup.removeData("_datePickerPopup");
                }
            };
            ...
            popup = AJS.InlineDialog($field, undefined, function (contents, trigger, showPopup) {
                ...
                parentPopup = $(trigger).closest('.aui-inline-dialog');
                parentPopup.data('_datePickerPopup', popup); // AUI-2696 - hackish coupling to control inline-dialog close behaviour.
