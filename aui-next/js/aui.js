...
(function($) {
    ...
    AJS.InlineDialog = function (items, identifier, url, options) {
        ...
        var hidePopup = function(delay) {
            ...
            if (popup.data("_datePickerPopup")) {
...
(function () {
    ...
    AJS.messages = {
        ...
        template: '<div class="aui-message aui-message-{type} {type} {closeable} {shadowed} {fadeout}"><p class="title"><strong>{title}</strong></p>{body}<!-- .aui-message --></div>',
...
(function ($, skate) {
    ...
    function Navigation(selector) {
        ...
        this.$el.find('> li[aria-expanded] > .aui-nav-subtree-toggle').on('click', function (e) {
            var nav = AJS.navigation($(this).siblings('.aui-nav'));
            nav.toggle();
        });
    ...
    $(function() {
        skate('aui-nav', function(element) {
            AJS.navigation(element);
        });
    });
    ...
    $(function ($) {
        ...
        sidebar.$el.find('.aui-sidebar-body').on('mouseenter mouseover mouseleave',function(e) {
            sidebar.$el.toggleClass('aui-is-hover',
                ...
                && !$(e.srcElement || e.target).parentsUntil(sidebar.$el).filter('.aui-page-header, .aui-navgroup').length);
            ...
            if (e.type === 'mouseover' && !$(e.srcElement).hasClass('active')) {
                sidebar.submenus.hide();
            }
        })
